...
function Arrow() {
	return (
		<svg
			className='arrow-svg'
			viewBox='0 0 975.6 157'
			style={{ background: 'new 0 0 975.6 157' }}
		>
			<motion.path
				initial={{ pathLength: 0 }}
				animate={{ pathLength: 1 }}
				transition={{ duration: 2 }}
				style={{ fill: 'transparent', stroke: 'black', strokeMiterlimit: 10 }}
				d='M0,156.5c48.9-1.8,84.8-25.2,89.4-52.9c3.6-22-11.5-52.7-28.2-54.1c-7.7-0.6-15.7,4.9-20,10.6
